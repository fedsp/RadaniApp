...
public class BLeSerialPortService extends Service implements BluetoothAdapter.LeScanCallback {
    ...
    public static final UUID SERIAL_SERVICE_UUID = UUID.fromString("bc2f4cc6-aaef-4351-9034-d66268e328f0");
    public static final UUID TX_CHAR_UUID = UUID.fromString("06d1e5e7-79ad-4a71-8faa-373789f7d93c");
    public static final UUID RX_CHAR_UUID = UUID.fromString("06d1e5e7-79ad-4a71-8faa-373789f7d93c");
