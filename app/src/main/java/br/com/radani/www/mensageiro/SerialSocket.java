...
class SerialSocket extends BluetoothGattCallback {
    ...
    private static final UUID BC6E934_SERVICE = UUID.fromString("bc2f4cc6-aaef-4351-9034-d66268e328f0");
    private static final UUID BC6E934_READ = UUID.fromString("06d1e5e7-79ad-4a71-8faa-373789f7d93c");
    private static final UUID BC6E934_WRITE = UUID.fromString("06d1e5e7-79ad-4a71-8faa-373789f7d93c");
    ...
    public void onServicesDiscovered(BluetoothGatt gatt, int status) {
        ...
        for (BluetoothGattService gattService : gatt.getServices()) {
            if (gattService.getUuid().equals(BC6E934_SERVICE)) {
                Log.d(TAG, "®®®®®®®®®®®®®®®®®®®®®®®®®®®®®®®®®®®®®®®®®®®®®®®®®");
                readCharacteristic = gattService.getCharacteristic(BC6E934_READ);
                writeCharacteristic = gattService.getCharacteristic(BC6E934_WRITE);
            }
            else {
                Log.d(TAG, "Dispositivo não cadastrado");
            }
        }
